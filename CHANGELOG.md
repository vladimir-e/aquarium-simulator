...
- **A scenario table** - `npm run scenarios` runs six maintained preset tanks headless and bands each reading green/amber/red by hobby plausibility; tweakable from `sim scenarios`.
