...
- **Darkness costs a plant** - the whole benefit budget is realised through photosynthesis and pays nothing at night, and an always-on maintenance cost puts a compensation point under it; peaks 0.1 → 0.125 to hold the ≈0.5 %/h budget (v23).- **A plant banks what it can't grow on** - growth draws a share of the reserve and withdraws only what became size, so a maxed plant fills its bank instead of burning it (v22).
