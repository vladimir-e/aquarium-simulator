...
- **The Water module is a lab sheet** - two columns of headed reading rows — water, gases and nutrients beside the cycle, its two guilds and the waste pool — every row opening the same inspector the Overview does.
