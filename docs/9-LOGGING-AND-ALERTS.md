...
- **event** _(optional)_ - Machine-readable discriminator for lifecycle moments consumers react to (`fish-died`, `plant-died`, `fish-spawned`, `eggs-laid`, `eggs-hatched`, `fry-sold`)
