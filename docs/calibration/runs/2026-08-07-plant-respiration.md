...
Date: 2026-08-07 · Branch: `light-response` · Register defect #35
...
phase (`2026-08-07-light-response.md`). The corrected reading of the same tank on
...
carries, and are corrected in place in `2026-08-07-light-response.md`.
