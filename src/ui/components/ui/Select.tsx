  ...
  return (
    <div className={`relative ${className}`}>
      <select
        ...
        className={`w-full appearance-none rounded-control border border-hairline bg-surface py-1.5 pl-3 pr-8 text-[13px] font-medium text-ink transition-colors hover:bg-surface-2 ${CONTROL_FOCUS} ${selectClassName}`}
      >
        {options.map((o) => (
