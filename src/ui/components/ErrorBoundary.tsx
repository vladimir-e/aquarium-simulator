  ...
  render(): ReactNode {
    ...
    return (
      ...
      >
        ...
        <pre className="max-w-full overflow-auto rounded-card border border-hairline bg-surface p-3 text-left font-mono text-[12px] text-alert">
          {errorMessage}
        </pre>
        <div className="flex flex-wrap items-center justify-center gap-2">
          <button
            ...
            className={`${BUTTON_BASE} bg-accent text-accent-ink hover:opacity-90`}
          >
            Try again
          </button>
          <button
            ...
            className={`${BUTTON_BASE} border border-hairline bg-surface text-alert hover:bg-surface-2`}
          >
            Reset saved tank
          </button>
        </div>
